...
const routes = [
  ...
  },
  {
    ...
    component: Loadable({
      loader: () =>
        import(
          /* webpackChunkName: "SinglePageView" */ './container/SinglePackage/SinglePackageView'
        ),
      loading: Loading,
      modules: ['SinglePackageView'],
    }),
  },
  {
  ...
  },
  {
    ...
    component: Loadable({
      loader: () =>
        import(/* webpackChunkName: "Pricing" */ './container/Services/Services'),
      loading: Loading,
      modules: ['Services'],
    }),
  },
