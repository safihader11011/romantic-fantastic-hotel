...
const SearchArea = ({ searchTitleStyle, searchDescriptionStyle }) => {
  return (
    <BannerWrapper style={{ backgroundImage: `url(${bannerBg4})` }}>
      {/* <GlideCarousel
        controls={false}
      ...
      <Container>
        <SearchWrapper>
          <Heading
            {...searchTitleStyle}
            content="Best Service Available for you"
          />
          <Text
            {...searchDescriptionStyle}
            content="compares prices from 200+ Hotels to help you find the Best Packages, you're looking for."
          />
          <SearchForm />
        </SearchWrapper>
      </Container>
